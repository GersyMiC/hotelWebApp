...
public class ServicioDAO {
    ...
    public ArrayList<Servicio> buscarPorServicio(String cadena) throws Exception {
        ...
        ArrayList<Servicio> servicios = new ArrayList<>(); // para métodos que usan instrucción SELECT
        ...
        return servicios;//QUITAR AL MODIFICAR
    }
    ...
    public Servicio buscarPorId(int id) throws Exception {
        ...
        Servicio servicio = null; // para métodos que usan instrucción SELECT
        ...
        return servicio;//QUITAR AL MODIFICAR
    }
