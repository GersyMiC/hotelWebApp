...
public class HabitacionDAO {
    ...
    public ArrayList<Habitacion> buscarPorHabitacion(String cadena) throws Exception {
        /*Connection con = null;
        CallableStatement cstm = null;
        ResultSet rs = null;*/ // para métodos que usan instrucción SELECT

        ArrayList<Habitacion> habitaciones = new ArrayList<>(); // para métodos que usan instrucción SELECT
        ...
        return habitaciones;//QUITAR AL MODIFICAR
    }
    ...
    public Habitacion buscarPorId(int id) throws Exception {
        ...
        Habitacion habitacion = null; // para métodos que usan instrucción SELECT
        ...
        return habitacion;//QUITAR AL MODIFICAR
    }
