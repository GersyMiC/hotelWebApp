...
public class ReciboDAO {
    ...
    public void insertar(Recibo recibo) throws Exception {
        /*Connection con = null;
    ...
    public ArrayList<Recibo> buscarPorRecibo(String cadena) throws Exception {
        ...
        ArrayList<Recibo> recibos = new ArrayList<>(); // para métodos que usan instrucción SELECT
        ...
        return recibos;//QUITAR AL MODIFICAR
    }
    ...
    public Recibo buscarPorId(int id) throws Exception {
        ...
        Recibo recibo = null; // para métodos que usan instrucción SELECT
        ...
        return recibo;//QUITAR AL MODIFICAR
    }
