 ...
 * @author Gersy
 */
public class ReciboServicioDAO {
    ...
    public void insertar(ReciboServicio reciboServicio) throws Exception {
        /*Connection con = null;
    ...
    public void actualizar(ReciboServicio reciboServicio) throws Exception {
        /*Connection con = null;
        CallableStatement cstm = null;
        try {
            con = Uconnection.getConnection();
    ...
    public ArrayList<ReciboServicio> buscarPorReciboServicio(String cadena) throws Exception {
        ...
        ArrayList<ReciboServicio> reciboServicios = new ArrayList<>(); // para métodos que usan instrucción SELECT
        ...
        return reciboServicios;//QUITAR AL MODIFICAR
    }
    ...
    public ReciboServicio buscarPorId(int id) throws Exception {
        ...
        ReciboServicio reciboServicio = null; // para métodos que usan instrucción SELECT
        ...
        return reciboServicio;//QUITAR AL MODIFICAR
    }
